...
export default function Hero() {
  return (
    <section
      className="min-h-screen flex flex-col md:flex-row items-center justify-between text-center md:text-left px-6 md:px-16 bg-cover bg-center relative"
    ...
    >
      ...
      {/* Avatar */}
      <div className="relative z-10 mt-10 md:mt-0 md:ml-10 w-[300px] h-[300px] md:w-[400px] md:h-[400px]">
        <Image
          src="/avatar.png"
